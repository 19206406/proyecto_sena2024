    ...
    <div class="wrapper">
        <aside>
            ...
            <nav>
                <ul>
                    ...
                    <li>
                        <a class="boton-menu boton-carrito" href="{{route('home')}}">Wellcome</a>
                    </li>
                </ul>
            </nav>
            <footer>
                <p class="texto-footer">Heladeria Dulce</p>
            </footer>
        </aside>
        ...
        <main>
            ...
            <div class="contenedor-carrito">
               <p class="carrito-vacio">Tu carrito esta funcionando</p>
